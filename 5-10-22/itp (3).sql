...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2022 at 03:26 AM
...
(1, 'admin', 'Superadmin', '', '1181203162@student.mmu.edu.my', 'Qwer@1234', 'Active', '2022-05-09', 'Product'),
(2, 'product', 'Product', 'test', 'adwda', 'Asdf@1234', 'Active', '2022-05-11', 'Product'),
(3, 'general', 'General', 'test', '1181203162@student.mmu.edu.my', 'Qwer@1234', 'Active', '2022-05-11', 'All Department'),
(4, 'SAdmin', 'S', 'Admin', '1201201535@student.mmu.edu.my', 'Vbnm@1234', 'Active', '2022-06-01', 'All Department'),
(5, 'RawMaterial', 'Raw', 'Material', 'adaw', 'Qwer@1234', 'Active', '2022-06-17', 'All Department'),
...
('2208', '2208 GEL BASE FOOD COLOURING PURPLE ', 0, 'bottle', 'Hot ', 4, '', 1),
...
('CM.WRT', 'Test1.011', 0, 'bag', 'Flours', 6, 'u=4168635097,4166952831&fm=253&app=138&f=JPEG&fmt=auto&q=75.webp', 4),
...
('ST', 'SANTAN', 0, 'kg', '', 4, '', 1),
('T1', 'test1', 0, 'pack', 'TEST 1  stor', 1, 'cheering_minions.gif', 1),
('T2', 'Test 2', 0, 'unit', '', 2, 'Randomness-random-5997130-1280-800.jpg', 1),
('T3', 'Test 3', 0, 'unit', '', 3, '8552.gif', 2),
('TDCF', 'TULIP DARK CHOC FILLING (DC3630F)', 0, 'kg', '', 4, '', 1),
('Test1.11stor', 'StorTest', 0, 'tong', 'Freezer', 4, '', 4),
('TestStor1.1111', 'StorTest1.0', 0, 'kg', 'Flours', 3, '', 1),
...
--
ALTER TABLE `stock`
  MODIFY `SID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
